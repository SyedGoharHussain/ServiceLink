...
/// Screen to display all reviews for a specific worker (for customers viewing)
class WorkerAllReviewsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('$workerName\'s Reviews'), elevation: 1),
